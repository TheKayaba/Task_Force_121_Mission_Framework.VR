...
// ====================================================================================
// - format: [group,groupID,m_LongName,unitSize,radioSettings]
...
// m_LongName: Longer version of the groupID used in things such as the radios, etc. (string)
...
private ["_grp"];
{
    ...
    if (!isNull _grp) then {
        if !((groupID _grp) isEqualTo _shortName) then {
            ...
            _grp setVariable ["m_groupIDSet",true,true];
        };
        _grp setVariable ["m_groupIdentifier",_identifier];
        _grp setVariable ["m_LongName",_longName];
        _grp setVariable ["m_gps_groupSize",_groupSize];
        _grp setVariable ["m_radioSettings",_radioArray];
    };
} forEach _groups;
